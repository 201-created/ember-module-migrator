...
var FileInfo = CoreObject.extend({
  ...
  updateImports: function(projectRoot, fileInfos) {
    ...
    try {
      ...
      console.log('warning: parsing file ' + this.name + ' failed to apply codeshift. Possible non-js file or no import statements. Returning original file unchanged. error: ' + e.message);
    }
  },
